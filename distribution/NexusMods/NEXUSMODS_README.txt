...
[/list]
For GOG / manual installation:
[list=1]
[*]Download RenameBuildings.zip from this page
[*]Extract to: ...\Kenshi\mods\RenameBuildings\
[*]Enable "RenameBuildings" in the game launcher
[/list]
...
[*][b]Configurable[/b] - Supports config through JSON (out of game) or Emkej's Mod Hub (in game). You can now override which buildings you are allowed to rename, allowing you to limit the types of buildings you can rename. You can also override the player check, so non-player buildings can be renamed.
[/list]
...
[list]
[*][url=https://www.nexusmods.com/kenshi/mods/847]RE_Kenshi[/url] (tested on v0.34, but likely latest version)
