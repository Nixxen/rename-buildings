...
The mod allows you to rename any player-owned building in Kenshi. It was designed for renaming workstations (e.g., "Cooking Stove" -> "Make Dustwich", and "Cooking Stove" -> "Make Food Cube"), but works for any building you own.
...
[b]How to Use[/b]
[list=1]
[*]Select a player-owned building (Cooking Store, Storm House, Research Bench, Iron Refinery, etc.)
